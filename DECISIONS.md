...
**Status:** Live and enabled (cited-source + Tier-1). 386 tests. Needs a live run to confirm Tier-1 flips the Groq date. Trust the human side-by-side read over the judge score ([[feedback_regressions]]).
