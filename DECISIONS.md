...
**Status:** Built but DISABLED by default pending precision fixes. Consistent with the session rule: a change that makes output worse falls back to known-good rather than piling on tuning ([[feedback_regressions]]).
