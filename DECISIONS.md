...
**Status:** Live and enabled (cited-source + Tier-1). 386 tests. A real CONTRADICTED catch is still *unobserved* — needs a run whose draft contains a corporate-event claim (e.g. a topic like "recent AI-hardware acquisitions and IPOs in 2026"). Trust the human side-by-side read over the judge score ([[feedback_regressions]]).
